    ...
    <div className="bg-gray-900 text-gray-100">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Ace Your Next <span className="text-indigo-400">Technical Interview</span>
              </h1>
              ...
              <div className="mb-8">
                <FileUpload 
                  ...
                  label="Upload Resume for Personalized Practice"
              ...
              <div className="flex space-x-4">
                ...
                <Link to="/demo" className="border border-indigo-600 text-indigo-400 hover:bg-gray-800 px-6 py-3 rounded-md font-medium transition duration-300">
                  Watch Demo
                </Link>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-gray-700 p-6 rounded-lg text-center">
              ...
              <div className="text-gray-300">Users Practiced</div>
            </div>
            <div className="bg-gray-700 p-6 rounded-lg text-center">
              <div className="text-3xl font-bold text-indigo-400 mb-2">500+</div>
              <div className="text-gray-300">Interview Questions</div>
            </div>
            <div className="bg-gray-700 p-6 rounded-lg text-center">
      ...
      <section className="py-16 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-8 rounded-xl hover:shadow-lg transition duration-300 border border-gray-700">
              <div className="bg-indigo-900/50 w-14 h-14 rounded-full flex items-center justify-center mb-6">
                <FaLaptopCode className="text-indigo-400 text-xl" />
              </div>
              <h3 className="text-xl font-semibold text-white mb-3">Practice Coding</h3>
            ...
            <div className="bg-gray-800 p-8 rounded-xl hover:shadow-lg transition duration-300 border border-gray-700">
              <div className="bg-indigo-900/50 w-14 h-14 rounded-full flex items-center justify-center mb-6">
                <BsFillPersonCheckFill className="text-indigo-400 text-xl" />
              </div>
      ...
      <section className="py-16 bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Practice For Any Interview</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="border border-gray-700 bg-gray-900 rounded-lg p-6 hover:shadow-lg transition duration-300">
              <div className="bg-blue-900/50 w-12 h-12 rounded-full flex items-center justify-center mb-4">
                <FaUsers className="text-blue-400" />
              </div>
              <h3 className="text-xl font-semibold text-white mb-3">Behavioral Interviews</h3>
              <p className="text-gray-400 mb-4">
                Practice answering common behavioral questions with our AI evaluation system.
              </p>
              <Link to="/behavioral" className="text-blue-400 hover:underline">Start Practicing →</Link>
            </div>
            
            <div className="border border-gray-700 bg-gray-900 rounded-lg p-6 hover:shadow-lg transition duration-300">
              <div className="bg-green-900/50 w-12 h-12 rounded-full flex items-center justify-center mb-4">
                <FaLaptopCode className="text-green-400" />
              </div>
              <h3 className="text-xl font-semibold text-white mb-3">Technical Interviews</h3>
              <p className="text-gray-400 mb-4">
                Solve coding challenges in our IDE with auto-complete and syntax highlighting.
              </p>
              <Link to="/technical" className="text-green-400 hover:underline">Start Practicing →</Link>
            </div>
            ...
            <div className="border border-gray-700 bg-gray-900 rounded-lg p-6 hover:shadow-lg transition duration-300">
              ...
              <Link to="/system-design" className="text-purple-400 hover:underline">Start Practicing →</Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full bg-indigo-900/50 flex items-center justify-center mr-4">
                  <span className="text-indigo-400 font-semibold">JS</span>
                </div>
                <div>
            ...
            <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full bg-indigo-900/50 flex items-center justify-center mr-4">
                  <span className="text-indigo-400 font-semibold">AP</span>
                </div>
                <div>
                  <h4 className="font-semibold text-white">Alice Park</h4>
                  <p className="text-gray-400 text-sm">Frontend Developer @ Meta</p>
                </div>
              </div>
              <p className="text-gray-300">
                "The behavioral interview practice was a game-changer. I learned how to structure my answers effectively."
            ...
            <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full bg-indigo-900/50 flex items-center justify-center mr-4">
                  <span className="text-indigo-400 font-semibold">MR</span>
                </div>
                <div>
                  <h4 className="font-semibold text-white">Miguel Rodriguez</h4>
                  <p className="text-gray-400 text-sm">Backend Engineer @ Amazon</p>
                </div>
              </div>
              <p className="text-gray-300">
                "Practicing system design questions on this platform prepared me perfectly for my Amazon interview loop."
      ...
      <section className="py-16 bg-indigo-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link to="/signup" className="bg-white text-indigo-900 px-8 py-3 rounded-md font-medium hover:bg-gray-100 transition duration-300 inline-block">
            Start Free Trial
          </Link>
        </div>
      </section>
