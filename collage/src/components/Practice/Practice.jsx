...
import { FaLaptopCode, FaChartLine, FaUserTie, FaFlask, FaMobileAlt, FaDatabase, FaShieldAlt, FaPencilAlt } from 'react-icons/fa';

const Practice = () => {
  const [activeTab, setActiveTab] = useState('all');
  const [searchQuery, setSearchQuery] = useState('');

  // Mock interview categories data
  const categories = [
    {
      id: 'software',
    ...
    },
    {
      ...
      icon: <FaFlask className="text-red-500 text-2xl" />,
      count: 8
    },
    {
      id: 'mobile',
      title: 'Mobile Development',
      icon: <FaMobileAlt className="text-yellow-500 text-2xl" />,
      count: 10
    },
    {
      id: 'database',
    ...
    },
    {
      id: 'design',
      title: 'UX/UI Design',
      icon: <FaPencilAlt className="text-pink-500 text-2xl" />,
      count: 11
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className={`px-4 py-2 rounded-lg ${activeTab === 'all' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-100'}`}
              >
                All Categories
              </button>
              <button
                onClick={() => setActiveTab('popular')}
                className={`px-4 py-2 rounded-lg ${activeTab === 'popular' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-100'}`}
              >
                Most Popular
              </button>
            </div>
            ...
            >
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-500">{category.count} interview sets</span>
                  {category.popular && (
        ...
        <div className="mt-16">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Featured Interview Tracks</h2>
            ...
            <div className="p-6">
              <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-gray-800">Full Stack Developer Track</h3>
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded">System Design</span>
                  </div>
                </div>
